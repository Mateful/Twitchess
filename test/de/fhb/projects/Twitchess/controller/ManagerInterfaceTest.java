...
public class ManagerInterfaceTest{
	...
	public void getParameterWithoutStartCommandTest() throws ChessManagerException{
	...
	public void processInputTest() throws SQLException{
		...
		System.out.println(cm.processInput("player1",message));
	...
	public void processInputInvalidComandTest() throws SQLException{
		...
		assertEquals("Error while processing your request: This is not a valid command!",cm.processInput("player1",message));
	}
}